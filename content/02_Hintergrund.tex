...
\textbf{Nachteile:} 
\begin{itemize}
	\item Da der Serverprozess nun ebenfalls auf einem Gerät läuft, auf welches Spieler Zugriff haben, gibt es ebenfalls mehr Möglichkeiten des Hackings (Spielmanipulation \cite{Grondahl.2000}). Die Entwickler haben keinerlei Einfluss auf die Serverprozesse, welche ein Spieler startet\cite{Smed.2002}. 
\end{itemize}
