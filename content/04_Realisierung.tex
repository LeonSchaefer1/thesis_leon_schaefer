...
\begin{enumerate}
	\item Das Feld 'spawnableCollectableObjects' enthält alle 'Collectable'-Objekte, 'spawnableDestinationObjects' alle 'Destination' Objekte, welche gespawnt werden können.
	\item 'possibleCollectableSpawnPoints' und 'possibleDestinationSpawnPoints' beinhalten alle möglichen Spawnpunkte für 'Collectable' und 'Destination' Objekte.
	\item 'amountOfCollectablesSetting' ist die vom Lobby-Leiter konfigurierte Anzahl an 'Collectable' Objekten, die in der Spielwelt platziert werden sollen.
	\item 'popCollectableSpawnpointAt' gibt einen Spawnpunkt für ein 'Collectable'-Objekt zurück für einen gegebenen Index.
	\item 'popCollectableObjectAt' gibt ein 'Collectable' Objekt zurück für einen gegebenen Index.
	\item 'popRelatedDestinationSpawnPoints' gibt drei Spawnpunkte zurück für einen gegebenen Index.
	\item 'popRelatedDestinationObjects' gibt drei 'Destination' Objekte zurück für einen gegebenen Index.
\end{enumerate}
